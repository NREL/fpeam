...
class Driver:
    ...
    def save_data(self, operation_dict, alloc, fips_list):
        ...
        # post-process data to obtain emissions from off-farm transportation and processing (transporation, adv; transportation, conv; processing, adv; processing, conv)
